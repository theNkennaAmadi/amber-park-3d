...
`;continue}if((N=T.match(y))&&(x.gamma=parseFloat(N[1])),(N=T.match(R))&&(x.exposure=parseFloat(N[1])),(N=T.match(L))&&(x.valid|=2,x.format=N[1]),(N=T.match(U))&&(x.valid|=4,x.height=parseInt(N[1],10),x.width=parseInt(N[2],10)),x.valid&2&&x.valid&4)break}return x.valid&2?x.valid&4?x:o(3,"missing image size specifier"):o(3,"missing format specifier")},_=function(g,S,y){const R=S;if(R<8||R>32767||g[0]!==2||g[1]!==2||g[2]&128)return new Uint8Array(g);if(R!==(g[2]<<8|g[3]))return o(3,"wrong scanline width");const L=new Uint8Array(4*S*y);if(!L.length)return o(4,"unable to allocate buffer space");let U=0,x=0;const T=4*R,N=new Uint8Array(4),Q=new Uint8Array(T);let F=y;for(;F>0&&x<g.byteLength;){if(x+4>g.byteLength)return o(1);if(N[0]=g[x++],N[1]=g[x++],N[2]=g[x++],N[3]=g[x++],N[0]!=2||N[1]!=2||(N[2]<<8|N[3])!=R)return o(3,"bad rgbe scanline format");let z=0,G;for(;z<T&&x<g.byteLength;){G=g[x++];const k=G>128;if(k&&(G-=128),G===0||z+G>T)return o(3,"bad scanline data");if(k){const q=g[x++];for(let ee=0;ee<G;ee++)Q[z++]=q}else Q.set(g.subarray(x,x+G),z),z+=G,x+=G}const j=R;for(let k=0;k<j;k++){let q=0;L[U]=Q[k+q],q+=R,L[U+1]=Q[k+q],q+=R,L[U+2]=Q[k+q],q+=R,L[U+3]=Q[k+q],U+=4}F--}return L},v=function(g,S,y,R){const L=g[S+3],U=Math.pow(2,L-128)/255;y[R+0]=g[S+0]*U,y[R+1]=g[S+1]*U,y[R+2]=g[S+2]*U,y[R+3]=1},p=function(g,S,y,R){const L=g[S+3],U=Math.pow(2,L-128)/255;y[R+0]=Bi.toHalfFloat(Math.min(g[S+0]*U,65504)),y[R+1]=Bi.toHalfFloat(Math.min(g[S+1]*U,65504)),y[R+2]=Bi.toHalfFloat(Math.min(g[S+2]*U,65504)),y[R+3]=Bi.toHalfFloat(1)},f=new Uint8Array(e);f.pos=0;const A=m(f);if(A!==-1){const g=A.width,S=A.height,y=_(f.subarray(f.pos),g,S);if(y!==-1){let R,L,U;switch(this.type){case Dt:U=y.length/4;const x=new Float32Array(U*4);for(let N=0;N<U;N++)v(y,N*4,x,N*4);R=x,L=Dt;break;case jt:U=y.length/4;const T=new Uint16Array(U*4);for(let N=0;N<U;N++)p(y,N*4,T,N*4);R=T,L=jt;break;default:console.error("THREE.RGBELoader: unsupported type: ",this.type);break}return{width:g,height:S,data:R,header:A.string,gamma:A.gamma,exposure:A.exposure,type:L}}}return null}setDataType(e){return this.type=e,this}load(e,t,n,r){function s(a,o){switch(a.type){case Dt:case jt:a.colorSpace=At,a.minFilter=ct,a.magFilter=ct,a.generateMipmaps=!1,a.flipY=!0;break}t&&t(a,o)}return super.load(e,s,n,r)}}class $p extends Ai{constructor(e){super(e)}load(e,t,n,r){const s=this,a=new zo(this.manager);a.setPath(this.path),a.setRequestHeader(this.requestHeader),a.setWithCredentials(this.withCredentials),a.load(e,function(o){const l=s.parse(JSON.parse(o));t&&t(l)},n,r)}parse(e){return new Qp(e)}}class Qp{constructor(e){this.isFont=!0,this.type="Font",this.data=e}generateShapes(e,t=100){const n=[],r=em(e,t,this.data);for(let s=0,a=r.length;s<a;s++)n.push(...r[s].toShapes());return n}}function em(i,e,t){const n=Array.from(i),r=e/t.resolution,s=(t.boundingBox.yMax-t.boundingBox.yMin+t.underlineThickness)*r,a=[];let o=0,l=0;for(let c=0;c<n.length;c++){const h=n[c];if(h===`
`)o=0,l-=s;else{const u=tm(h,r,o,l,t);o+=u.offsetX,a.push(u.path)}}return a}function tm(i,e,t,n,r){const s=r.glyphs[i]||r.glyphs["?"];if(!s){console.error('THREE.Font: character "'+i+'" does not exists in font family '+r.familyName+".");return}const a=new Kp;let o,l,c,h,u,d,m,_;if(s.o){const v=s._cachedOutline||(s._cachedOutline=s.o.split(" "));for(let p=0,f=v.length;p<f;)switch(v[p++]){case"m":o=v[p++]*e+t,l=v[p++]*e+n,a.moveTo(o,l);break;case"l":o=v[p++]*e+t,l=v[p++]*e+n,a.lineTo(o,l);break;case"q":c=v[p++]*e+t,h=v[p++]*e+n,u=v[p++]*e+t,d=v[p++]*e+n,a.quadraticCurveTo(u,d,c,h);break;case"b":c=v[p++]*e+t,h=v[p++]*e+n,u=v[p++]*e+t,d=v[p++]*e+n,m=v[p++]*e+t,_=v[p++]*e+n,a.bezierCurveTo(u,d,m,_,c,h);break}}return{offsetX:s.ha*e,path:a}}class $a extends xs{constructor(e,t={}){const n=t.font;if(n===void 0)super();else{const r=n.generateShapes(e,t.size);t.depth=t.height!==void 0?t.height:50,t.bevelThickness===void 0&&(t.bevelThickness=10),t.bevelSize===void 0&&(t.bevelSize=8),t.bevelEnabled===void 0&&(t.bevelEnabled=!1),super(r,t)}this.type="TextGeometry"}}Tt.enabled=!1;const sn={color:16777215,transmission:1,opacity:1,metalness:0,roughness:0,ior:1.52,thickness:.1,specularIntensity:1,specularColor:16777215,lightIntensity:1,exposure:1},Ho=document.querySelector(".webgl1"),fr=new tp,Vo=new Jp().load("https://dl.polyhaven.org/file/ph-assets/HDRIs/hdr/1k/satara_night_1k.hdr",function(){Vo.mapping=ir});fr.environment=Vo;const nm=new kp,im=nm.load("https://cdn.jsdelivr.net/gh/theNkennaAmadi/amber-park-3d@main/dist/textures/matcaps/Iridescent/30.png"),rm=new Fp({color:sn.color,metalness:sn.metalness,roughness:sn.roughness,ior:sn.ior,transmission:sn.transmission,specularIntensity:sn.specularIntensity,specularColor:sn.specularColor,opacity:sn.opacity,side:Ot}),sm=new $p;let ar,$r;sm.load("https://cdn.jsdelivr.net/gh/theNkennaAmadi/amber-park-3d@main/dist/fonts/Iskry.json",async i=>{const e=new Op({matcap:im}),t=new $a("AP",{font:i,size:20,height:3,curveSegments:24,bevelEnabled:!0,bevelThickness:.01,bevelSize:.02,bevelOffset:0,bevelSegments:5});t.center(),ar=new It(t,e);const n=new $a("e",{font:i,size:20,height:3,curveSegments:24,bevelEnabled:!0,bevelThickness:.01,bevelSize:.02,bevelOffset:0,bevelSegments:5});n.center(),$r=new It(n,e);let r=new cr(20,20,20,5);r.translate(0,10,0),r.center();const s=new It(r,rm);fr.add(ar,$r,s),$r.visible=!1,s.visible=!1});new qp(16777215,1);new Yp("red",.5);const an={width:window.innerWidth,height:window.innerHeight};window.addEventListener("resize",()=>{an.width=window.innerWidth,an.height=window.innerHeight,oi.aspect=an.width/an.height,oi.updateProjectionMatrix(),Ln.setSize(an.width,an.height),Ln.setPixelRatio(Math.min(window.devicePixelRatio,2))});const oi=new bt(40,window.innerWidth/window.innerHeight,1,2e3);oi.position.set(0,0,120);fr.add(oi);const am=new jp(oi,Ho);am.enableDamping=!0;const Ln=new Po({canvas:Ho,antialias:!0,alpha:!0});Ln.shadowMap.enabled=!0;Ln.outputColorSpace=At;Ln.setSize(an.width,an.height);Ln.setPixelRatio(Math.min(window.devicePixelRatio,2));const om=new Zp,ko=()=>{const i=om.getElapsedTime();ar&&(ar.rotation.y=i),Ln.render(fr,oi),window.requestAnimationFrame(ko)};ko();
//# sourceMappingURL=index-f389d887.js.map
